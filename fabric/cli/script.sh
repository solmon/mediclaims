...
CORE_PEER_MSPCONFIGPATH=/peers/customerPeer/localMspConfig CORE_PEER_ADDRESS=customer-peer:7051 CORE_PEER_LOCALMSPID=CustomerOrgMSP CORE_PEER_TLS_ROOTCERT_FILE=/peers/customerPeer/localMspConfig/cacerts/customerOrg.pem peer channel join -b default.block

CORE_PEER_MSPCONFIGPATH=/peers/hospitalPeer/localMspConfig CORE_PEER_ADDRESS=hospitalservice-peer:7051 CORE_PEER_LOCALMSPID=HospitalOrgMSP CORE_PEER_TLS_ROOTCERT_FILE=/peers/hospitalPeer/localMspConfig/cacerts/hospitalOrg.pem peer channel join -b default.block
